    ...
    <section class="information" style="display: block">
        <form class="user-form" id="login" action="index.php?destination=login" method="post">
            ...
            <div class="button-container">
                <button class="generic-button" type="reset" onclick="hideForm()" title="cancel login">
                    <img src="./content/error.svg" alt="cancel login">CANCEL
                </button>
                <button class="generic-button" type="submit" title="login to your account">
                    <img src="./content/success.svg" alt="submit login">LOGIN
                </button>
            </div>
        </form>
        <form class="user-form" id="signup" action="index.php?destination=signup" method="post">
            ...
            <div class="button-container">
                <button class="generic-button" type="reset" onclick="hideForm()" title="cancel profile creation">
                    <img src="./content/error.svg" alt="cancel profile">CANCEL
                </button>
                <button class="generic-button" type="submit" title="submit your profile">
                    <img src="./content/success.svg" alt="submit profile">SIGNUP
                </button>
            </div>
        </form>
    </section>
